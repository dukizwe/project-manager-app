                    ...
                    <>
                              ...
                              <View style={styles.container}>
                                        <View style={{ padding: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                                                  <Heading>Taches</Heading>
                                                  {user.ID_POSTE != 7 ? <TouchableOpacity onPress={() => navigation.navigate("NewTacheScreen")}>
                                        ...
                                        {loadingTaches ? <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                                                  ...
                                                  {taches.map((tache, index) => {
                                                            return (
                                                                      <Tache tache={tache} key={index} setShowProgress={setShowProgress} modalRef={modalRef} />
                                                            )
                                                  })}
                                        </ScrollView>}
                              </View>
