                           ...
                           <View style={styles.affectationsDescription}>
                              <View style={styles.projetProgress}>
                                 <View style={styles.progression}>
                                    <View style={[styles.progressionValue, { width: projet.PROGRESSION_GROBALE ? `${projet.PROGRESSION_GROBALE}%` : 0 }, projet.PROGRESSION_GROBALE == 100 && { backgroundColor: COLORS.primary }]} />
                                 </View>
