...
export default function Risque() {
          ...
          const isValid = projet && projet != '' && tacheValue && tacheValue != '' && client!='' && partenaire !='' &&  contact!='' && telephone!='' && avancement!='' && risque!=''
                         && impact!='' && degre!='' && action!='' && origin!='' && abandon!='' && livrable!='' && priorite!=''
          ...
          const submitForm = async () => {
                    ...
                    try {
                              const risqueData = {
                                        ...
                                        CLIENT:client,
                                        ID_RESPONSABLE:responsable.value,
                              ...
                              <ScrollView style={styles.container} keyboardShouldPersistTaps='always'>
                                        ...
                                        />
                                         <Input value={contact} onChangeText={(value) => setContact(value)} mt={2} placeholder="Personne de contact" size='lg' py={2} InputLeftElement={
                                                  ...
                                                  />}
                                        />
                                         <Input keyboardType='number-pad' value={telephone} onChangeText={(value) => setTelephone(value)} mt={2} placeholder="Téléphone" size='lg' py={2} InputLeftElement={
                                                  <Icon
                                        ...
                                        <Input keyboardType='number-pad' value={avancement} onChangeText={(value) => setAvencement(value)} mt={2} placeholder="Etat d'avancement" size='lg' py={2} InputLeftElement={
                                                  <Icon
                                        ...
                                        <Input value={risque} multiline onChangeText={(value) => setRisque(value)} mt={2} placeholder="Risque" size='lg' py={2} InputLeftElement={
                                                  <Icon
